...
@EnableJpaRepositories(basePackages = { "com.saas.application.master.entity",
		"com.saas.application.master.repository" }, entityManagerFactoryRef = "masterEntityManagerFactory", transactionManagerRef = "masterTransactionManager")
