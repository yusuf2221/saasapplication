...
@ComponentScan(basePackages = { "com.saas.application.tenant.repository", "com.saas.application.tenant.entity" })
@EnableJpaRepositories(basePackages = {"com.saas.application.tenant.repository", "com.saas.application.tenant.service" },
...
public class TenantDatabaseConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(
        ...
        emfBean.setPackagesToScan("com.saas.application");
